...
| Contract reviewer | [Source snapshot quality](reference/source-snapshot-quality.md), [deterministic report schema](reference/deterministic-report-schema.md), [semantic claim-plan contract](reference/semantic-claim-plan-contract.md) or [semantic claim-plan rendering](reference/semantic-claim-plan-rendering.md) |
